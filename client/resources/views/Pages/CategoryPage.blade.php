                ...
                if(i == 0){
                    ...
                    $('#CategorySideNews').append(`
                        <div class="col-12 col-sm-6 col-md-6 col-lg-12">
                            <a href="/get-news/${news[i].id}" class="card border-0 p-2 d-block pt-0 pb-0 link" >
                    ...
                    $('#CategorySideNews').append(`
                         <div class="col-12 col-sm-6 col-md-6 col-lg-12">
                            <a  href="/get-news/${news[i].id}" class="card border-0 d-block p-2 pt-0 pb-0 link">
            ...
            for(let i = 3; i < news.length; i++){
                $('#CategoryMoreNews').append(`
                    <div class="col-12  col-sm-6 col-md-6 col-lg-4">
                        <a href="/get-news/${news[i].id}" class="card border-0 pt-0 pb-0 link">
